...
def indiv(hero):
    ...
    if y in ["albedo", "aloy", "amber", "arataki itto", "barbara", "beidou", "bennett", "chongyun", "diluc", "diona", "eula", "fischl", "ganyu", "gorou", "hu tao", "jean", "kaedehara kazuha", "kaeya", "kamisato ayaka", "kamisato ayato", "keqing", "klee", "kujou sara", "lisa", "mona", "ningguang", "noelle", "qiqi", "raiden shogun", "razor", "rosaria", "sangonomiya kokomi", "sayu", "shenhe", "sucrose", "tartaglia", "thoma", "traveler anemo", "traveler geo", "traveler electro", "venti", "xiangling", "xiao", "xinyan", "xinqiu", "yae miko", "yanfei", "yoimiya", "yunjin", "zhongli",]:
        ...
        return render_template("indiv/" + x + ".html", sibl=n)
        ...
        if y in  ["kukishinobu", "kuki", "shinobu", "shinobu kuki", "shinobukuki",]:
            y = "kuki shinobu"
        x = y.title()
        return render_template("nope.html", name=x, aftertext="Sorry! this character has not been released yet", sibl=n)

    elif y in ["kamisato"]:
        return render_template("nope.html", name="Kamisato", aftertext="Please specify which sibling.", command="bruh", sibl=n)

    elif y in ["who"]:
        return render_template("nope.html", name="Who?", aftertext="Tao, yes", sibl=n)

    elif y in ["aether", "lumine", "traveler"]:
        return render_template("nope.html", name="Traveler", aftertext="Please specify which element.", command2="bruh2", sibl=n)

    else:
        return render_template("nope.html", name="Unknown", aftertext="Sorry! this character does not exist", sibl=n)